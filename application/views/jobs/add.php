 	...
 	<div id="page-content">
 		...
 		<div class="row">
 				<div class="panel">
 					...
 					<!--Block Styled Form -->
 					<!--===================================================-->
 					<?php echo form_open_multipart('jobs/add_now'); ?>
 					<form>
 					<div class="panel-body">
 						<div class="row">
 							...
 							<div class="form-group">
 								...
 								<input type="text" class="form-control" name="Job_Name" value="<?php echo set_value('Job_Name'); ?>" placeholder="Enter Job Name">
 						...
 						<div class="row">
 							<div class="col-sm-9">
 								<div class="form-group">
	 								...
	 								<input type="text" class="form-control" name="Job_Location" value="<?php echo set_value('Job_Location'); ?>" placeholder="Enter Job Location">
 							...
 							<div class="col-sm-3">
 								<div class="form-group">
 									...
 									<select name="Job_Barangay_ID" class="selectpicker form-control">
 						...
 						<div class="row">
 							<div class="col-sm-4">
 								...
 								<input type="text" class="form-control" name="Job_Benefits" value="<?php echo set_value('Job_Benefits'); ?>" placeholder="Enter Benefits">
 							...
 							<div class="col-sm-4">
 								...
 								<input type="text" class="form-control" name="Job_Dress_Code" value="<?php echo set_value('Job_Dress_Code'); ?>" placeholder="Enter Dress Code">
 							...
 							<div class="col-sm-4">
 								...
 								<input type="text" class="form-control" name="Job_Working_Hours" value="<?php echo set_value('Job_Working_Hours'); ?>" placeholder="Enter Working Hours">
 						...
 						<div class="row">
 							<div class="col-sm-4">
 								...
 								<input type="text" class="form-control" name="Job_Minimum_Year_Exp" value="<?php echo set_value('Job_Minimum_Year_Exp'); ?>" placeholder="Enter Minimum Working Experience">
 							...
 							<div class="col-sm-4">
 								...
 								<input type="text" class="form-control" name="Job_Salary_Rate_Range" value="<?php echo set_value('Job_Salary_Rate_Range'); ?>" placeholder="Enter Salary Rate Range">
 							...
 							<div class="col-sm-4">
 								...
 								<input type="text" class="form-control" name="Job_Date_Closed" value="<?php echo set_value('Job_Date_Closed'); ?>" placeholder="Enter Closing Date" onclick="this.type='date'" onblur="this.type='text'">
 						...
 						<div class="form-group">
 							...
 							<textarea placeholder="Job Description" name="Job_Description" rows="10" class="form-control"></textarea>
 							</div>
 							</div>
 						...
 						<div class="form-group">
 							...
 							<textarea placeholder="Job Qualification" name="Job_Qualification" rows="10" class="form-control"></textarea>
 							</div>
 							</div>
 						</div>
 					</div>
