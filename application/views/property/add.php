 ...
 <div id="content-container">
 	...
 	<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
 	<div id="page-title">
 		<h1 class="page-header text-overflow">New Property Registration</h1>
 	</div>
 	<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
 	<!--End page title-->
 	...
 	<ol class="breadcrumb">
 		<li><a href="#">Home</a></li>
 		<li class="active">Register New Property</li>
 	</ol>
 	<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
 	<!--End breadcrumb-->
 			...
 			<div class="col-sm-6">
 				<div class="panel">
 					<div class="panel-heading">
 						<h3 class="panel-title">Property Registration Form</h3>
 					</div>

 					<!--Block Styled Form -->
 					<!--===================================================-->
 					<?php echo form_open('property/property_add_now'); ?>
 					<div class="panel-body">
 						<div class="row">
 							<div class="col-sm-6">
 								<div class="form-group">
 									<label class="control-label">Property Name</label>
 									<input type="text" class="form-control" name="REP_Name" value="<?php echo set_value('REP_Name'); ?>" placeholder="Enter Property Name">
 							...
 							<div class="col-sm-9">
 								<div class="form-group">
 									...
 									<div class="input-group mar-btm">
 										<input id="Property_Address_Name" type="text" class="form-control" name="Property_Address_Name" value="<?php echo set_value('Property_Address_Name'); ?>" placeholder="Enter Property Address" required readonly>
 										<span class="input-group-btn">
 											<button class="btn btn-success" type="button" data-toggle="modal" data-target="#myModalSearch">+</button>
 										</span>
 									</div>
 									<input id="Address_ID" type="hidden" name="Address_ID" value="<?php echo set_value('Address_ID'); ?>">
 									<input id="Citizen_ID" type="hidden" name="Citizen_ID" value="<?php echo $citizen_data[0]->Citizen_ID; ?>">
 									<input id="Barangay_ID" type="hidden" name="Barangay_ID">
 						...
 						<div class="row">
 							<div class="col-sm-6">
 								<div class="form-group">
 									...
 									<input type="number" class="form-control" name="REP_No_Of_Units" value="<?php echo set_value('REP_No_Of_Units'); ?>" placeholder="Enter Number of Units">
 							...
 							<div class="col-sm-6">
 								<div class="form-group">
 									...
 									<select id="unitType" name="REP_Unit_Type" class="selectpicker form-control">
 						...
 						<div class="row">
 							<div class="col-sm-6">
 								<div class="form-group">
 									...
 									<input type="text" class="form-control" max="<?php echo Date('Y-m-d'); ?>" name="REP_Submission_Date" onclick="this.type='date'" onblur="this.type='text'" value="<?php echo set_value('REP_Submission_Date'); ?>" placeholder="Enter Submission Date">
