 		...
 		<div class="row">
 			<div class="panel">
 				<div class="panel-heading">
 					<h3 class="panel-title"><?php echo $citizen_data[0]->Citizen_Title.'. '.$citizen_data[0]->Citizen_LastName.', '.$citizen_data[0]->Citizen_FirstName.' '.$citizen_data[0]->Citizen_MiddleName; ?> <?php echo $citizen_data[0]->Citizen_Suffix == 'NA'? '':$citizen_data[0]->Citizen_Suffix; ?></h3>
 				</div>

 				<!--Block Styled Form -->
 				<!--===================================================-->
 				<div class="panel-body">
 					<?php echo form_open('womensdesk/add_now'); ?>
 					<div class="row">
 						<div class="col-md-3">
 						...
 						<div class="col-md-3">
 							<div class="form-group">
 								...
 								<div class="input-group mar-btm">
 									<input id="Guardian_Citizen_ID_Name" type="text" class="form-control" name="Guardian_Citizen_ID_Name" value="<?php echo set_value('Guardian_Citizen_ID_Name'); ?>" placeholder="Enter Guardian/Parents Name" required readonly>
 									<input id="Guardian_Citizen_ID" type="hidden" name="Guardian_Citizen_ID" value="<?php echo set_value('Guardian_Citizen_ID'); ?>">
 					...
 					<div class="row">
 						<div class="col-sm-3">
 							<div class="form-group">
 								...
 								<input type="text" class="form-control" name="Apprehension_DateTime" value="<?php echo set_value('Apprehension_DateTime'); ?>" placeholder="Enter Date and Time" onclick="this.type='datetime-local'" onblur="this.type='text'">
 						...
 						<div class="col-sm-9">
 							<div class="form-group">
 								...
 								<input type="text" class="form-control" name="Apprehension_Location" value="<?php echo set_value('Apprehension_Location'); ?>" placeholder="Enter Location">
 					...
 					<div class="row">
 						<div class="form-group">
 							...
 							<textarea placeholder="Apprehension Narrative" name="Apprehension_Narrative" rows="11" class="form-control"></textarea>
 						</div>
 					</div>
 					<div class="row">
 						<div class="form-group">
 							<label class="control-label">Remarks</label>
 							<textarea placeholder="Remarks" name="Apprehension_Remarks" rows="4" class="form-control"></textarea>
 						</div>
 					</div>
 					<div class="row">
 						<div class="col-md-3">
 							<div class="form-group">
 								...
 								<input type="text" class="form-control" name="OIC_FullName" value="<?php echo set_value('OIC_FullName'); ?>" placeholder="Enter OIC Full Name">
